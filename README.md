...
A drop-in solution for accepting lightning payments, built on top of [c-lightning](https://github.com/Datascietistabhi/lightningbro-charge.git).
...
Setup [c-lightning](https://github.com/Datascietistabhi/lightningbro-charge.git#getting-started) and nodejs (v7.6 or newer), then:

```bash
$ npm install -g lightningbro-charge
